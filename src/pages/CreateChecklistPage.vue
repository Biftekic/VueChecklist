...
import ReviewStep from '@/components/checklist/ReviewStep.vue'
...
const saveChecklist = async () => {
  const checklist = checklistsStore.newChecklist
  const id = await checklistsStore.createChecklist(checklist)
  
  if (id) {
    appStore.showNotification('Checklist saved successfully!', 'success')
    checklistsStore.resetNewChecklist()
